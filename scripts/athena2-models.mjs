...
export const ATHENA2_MODELS = [
  ...
  model(
    ...
    {
      geometryParts: [
        { name: "Sword", source: "attack", bindAnchor: "Weap01" },
      ],
      joinInBlender: false,
...
function model(unit, source, slug, attack, run, die, options = {}) {
  ...
  if (
    ...
    (!Array.isArray(runGround.bones) ||
      ...
      !runGround.bones.every(
        (bone) => typeof bone === "string" && bone.length > 0,
      ) ||
  ...
  return Object.freeze({
    ...
    joinInBlender: options.unitySampledSkeleton
      ? false
      : (options.joinInBlender ?? true),
