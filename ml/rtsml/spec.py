...
UPGRADE_BUILDING = SPEC.type_index("UpgradeBuilding")
CANCEL_UPGRADE = SPEC.type_index("CancelUpgrade")

MULTI_SELECT = (MOVE, ATTACK_MOVE, ATTACK, HARVEST, STOP, HOLD)
SINGLE_SELECT = (BUILD, TRAIN, CANCEL_TRAIN, SET_RALLY, UPGRADE_BUILDING, CANCEL_UPGRADE)
